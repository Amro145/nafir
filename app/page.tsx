      ...
      <div className="w-full max-w-3xl relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-1000">
        <div className="flex flex-col items-center text-center space-y-10">
          ...
          <div className="relative group">
            ...
            <div className="relative flex items-center justify-center space-x-3 bg-slate-900/80 p-5 rounded-4xl border border-white/10 shadow-2xl backdrop-blur-md">
          ...
          <div className="space-y-5">
            <h1 className="text-5xl md:text-7xl font-extrabold text-transparent bg-clip-text bg-linear-to-br from-white via-slate-200 to-slate-500 tracking-tight drop-shadow-sm">
              {t('branding')}
            </h1>
